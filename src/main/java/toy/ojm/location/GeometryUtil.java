...
public class GeometryUtil {
    ...
    public static Coordinates calculate(
        Double baseLatitude, Double baseLongitude, Double distance, Double bearing
    ){
        ...
        return new Coordinates(toDegree(latitude), toDegree(longitude));
    }
