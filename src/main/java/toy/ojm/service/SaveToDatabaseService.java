...
//
//    public void saveRestaurants(List<Restaurant> restaurantEntities) {
//        for (Restaurant entity : restaurantEntities) {
...
//        }
//    }
//        private void insertData(Restaurant entity) { // RestaurantEntity를 데이터베이스에 삽입하는 메서드
//            try {
